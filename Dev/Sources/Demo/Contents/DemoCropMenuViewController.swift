...
final class DemoCropMenuViewController: StackScrollNodeViewController {
  private lazy var stackForHorizontal: EditingStack = Mocks.makeEditingStack(
    image: Asset.horizontalRect.image
  )
  private lazy var stackForVertical: EditingStack = Mocks.makeEditingStack(
    image: Asset.verticalRect.image
  )
  private lazy var stackForSquare: EditingStack = Mocks.makeEditingStack(
    image: Asset.squareRect.image
  )
  private lazy var stackForSmall: EditingStack = Mocks.makeEditingStack(
  ...
  override func viewDidLoad() {
    ...
    stackScrollNode.append(nodes: [
      ...
      Components.makeSelectionCell(
        title: "Face detection - picker - square",
        onTap: { [unowned self] in
      ...
      Components.makeSelectionCell(
        title: "Horizontal rect from UIImage",
        onTap: { [unowned self] in
      ...
      Components.makeSelectionCell(
        title: "Vertical rect from UIImage",
        onTap: { [unowned self] in
      ...
      Components.makeSelectionCell(
        title: "Square rect from UIImage",
        onTap: { [unowned self] in
      ...
      Components.makeSelectionCell(
        title: "Super small rect from UIImage",
        onTap: { [unowned self] in
      ...
      Components.makeSelectionCell(
        title: "Super large rect from file URL",
        onTap: { [unowned self] in
      ...
      Components.makeSelectionCell(
        title: "Remote image (no retains stack)",
        onTap: { [unowned self] in
      ...
      Components.makeSelectionCell(
        title: "Remote image with preview (no retains stack)",
        onTap: { [unowned self] in
  ...
  private func _presentCropViewConroller(
    _ editingStack: EditingStack,
    fixedAspectRatio: PixelAspectRatio? = nil
  ) {
    var options = PhotosCropViewController.Options()
